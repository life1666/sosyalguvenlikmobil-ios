...
void main() {
  runApp(const EmeklilikHesaplama4bApp());
}

class EmeklilikHesaplama4bApp extends StatelessWidget {
  const EmeklilikHesaplama4bApp({super.key});
...
class EmeklilikHesaplama4bSayfasi extends StatefulWidget {
  ...
  const EmeklilikHesaplama4bSayfasi({super.key, this.inline = false, this.onBack});
...
class _EmeklilikHesaplama4bSayfasiState extends State<EmeklilikHesaplama4bSayfasi> {
  ...
  /// ======================================================
  /// >>> SWAPLANAN HESAPLAMA MOTORU (sadece bu fonksiyon değişti)
  /// ======================================================
  Map<String, dynamic> emeklilikHesapla(
    ...
    if (!ageLimitEligible && reqPrimYas > 0) {
      ...
      tahminiSonuclar["Yaş Haddinden Emeklilik"] = {
        ...
        "eksikYil": eksikYilDouble > 0 ? eksikYilDouble : 0,
        "mesaj":
        "Hesaplama Tarihi İtibarıyla Sigorta Bildirimleriniz Kesintisiz Devam Ederse, ${_formatDateDot(primDolma)} Tarihinde Yaş Haddinden Emeklilik Hakkı Kazanabilirsiniz."
      };
    }
  ...
  Future<void> _showResultBottomSheet() async {
    ...
    try {
      ...
      final sonHesaplama = SonHesaplama(
        ...
        hesaplamaTuru: '4/b (Bağ-kur) Emeklilik Hesaplama',
        tarihSaat: DateTime.now(),
        veriler: veriler,
        sonuclar: sonuclar,
      ...
      AnalyticsHelper.logCalculation('emeklilik_4b', parameters: {
        'hesaplama_turu': '4/b (Bağ-Kur) Emeklilik',
  ...
  List<Widget> _build4bSonucDetayRows(Map<String, String> detaylar, Map<String, dynamic> tahmini) {
  ...
  Widget _buildResultView() {
    ...
    final sonucSatirlari = _build4bSonucDetayRows(detaylar, tahmini);
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.store_rounded, color: green, size: 28),
                        ),
                        const SizedBox(height: 16),
                        const Text(
                          'Emeklilik Hesaplama (4/b Bağ-Kur)',
