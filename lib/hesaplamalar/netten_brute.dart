...
class NettenBruteScreen extends StatefulWidget {
  ...
  const NettenBruteScreen({super.key, this.inline = false, this.onBack});
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                detailRow('Net', _cellText(row.cells[1]), emphasize: true),
                detailRow('Brüt', _cellText(row.cells[2])),
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Netten brüte hesaplama tamamlandı ($_selectedYear).',
            ...
            child: Column(
              ...
              children: [
                ...
                if (totalRow != null) ...[
                  ...
                  const SizedBox(height: 8),
                  detailRow('Net', _cellText(totalRow.cells[1]), emphasize: true),
                  detailRow('Brüt', _cellText(totalRow.cells[2])),
          ...
          if (totalRow != null) ...[
            ...
            Container(
              ...
              child: Text(
                'Yıllık net: ${_cellText(totalRow.cells[1])} · Yıllık brüt: ${_cellText(totalRow.cells[2])}',
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.swap_vert_rounded, color: green, size: 28),
                      ),
                      const SizedBox(height: 16),
                      const Text(
