...
import 'emeklilik_4a_helper.dart';
...
class EmeklilikHesaplama4aSayfasi extends StatefulWidget {
  ...
  const EmeklilikHesaplama4aSayfasi({super.key, this.inline = false, this.onBack});
...
class _EmeklilikHesaplama4aSayfasiState extends State<EmeklilikHesaplama4aSayfasi> {
  ...
  Future<void> _showResultBottomSheet() async {
    ...
    setState(() {
      hesaplamaSonucu = emeklilikHesapla4a(
  ...
  List<Widget> _build4aSonucDetayRows(Map<String, String> detaylar, Map<String, dynamic> tahmini) {
  ...
  Widget _buildResultView() {
    ...
    final sonucSatirlari = _build4aSonucDetayRows(detaylar, tahmini);
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.shield_rounded, color: green, size: 28),
                        ),
                        const SizedBox(height: 16),
                        const Text(
                          'Emeklilik Hesaplama (4/a SSK)',
